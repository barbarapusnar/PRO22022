...
namespace LinqNaObjekte
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            var x2 = kupci.Select(a => new { a.Ime, a.Priimek });
            ...
            var x3 = podjetja.Where(a => a.Država == "Slovenija").Select(a => a.ImePodjetja);
            ...
            //         select a.ImePodjetja;
            var x4 = podjetja.OrderBy(a => a.ImePodjetja).Select(a => a.ImePodjetja);
            ...
            //          select a).Count();
            var x6 = podjetja.Where(a => a.Država == "Slovenija").Count();
            ...
            var x7 = podjetja.Select(a => a.Država).Distinct().Count();
            ...
            //         select p;
            var x8 = kupci.GroupBy(a => a.Podjetje);
